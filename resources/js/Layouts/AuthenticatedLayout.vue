                        ...
                        <div class="dropdowns hidden sm:flex sm:justify-content: flex-end">
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                <div class="ml-3 relative">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="'https://github.com/nichow'"> 
                                            GitHub 
                                        </DropdownLink>
                                        <DropdownLink :href="'https://bsky.app/profile/nichow.bsky.social'">
                                            BlueSky
                                        </DropdownLink>
                                        <DropdownLink :href="'https://linkedin.com/in/nicolas-garcia-4b0541140/'">
                                            LinkedIn
                                        </DropdownLink>
                                    </template>
                                    </Dropdown>
